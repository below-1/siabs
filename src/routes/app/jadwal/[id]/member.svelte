...
<div class="container px-4 flex flex-col py-6">
  <div class="w-full">
    <div class="flex flex-col md:flex-row justify-center md:items-center mb-6 gap-x-2 gap-y-2">
        ...
        >
          ...
          <div class="flex-grow">
            <div class="md:flex md:gap-x-3">
              ...
              <div class="hidden md:block font-bold">{member.pegawai.nip}</div>
            </div>
          ...
          <div class="flex items-center gap-x-2">
            {#if !member.waktu}
              ...
              <div class="hidden md:block italic text-xs">Menunggu Login</div>
            {:else}
              <div class="rounded-full h-4 w-4 bg-green-500"></div>
              <div class="hidden md:block italic text-xs">Telah Absen</div>
            {/if}
          </div>
        </a>
      {/each}
